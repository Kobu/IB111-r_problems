...
def main() -> None:
    assert differentiate(to_fraction_lst([1])) == to_fraction_lst([0])
    assert differentiate(to_fraction_lst([0])) == to_fraction_lst([0])
    assert differentiate(to_fraction_lst([1, 0])) == to_fraction_lst([1])
    assert differentiate(to_fraction_lst([3, 2, 1])) == to_fraction_lst([6, 2])
    assert differentiate(to_fraction_lst([1, 5, 12, -4, -2, 0, 1])) == to_fraction_lst(
        [6, 25, 48, -12, -4, 0]
    )
    assert differentiate(
        to_fraction_lst([-4, 0, 0, 2, 0, -1, 0, 0, 0])
    ) == to_fraction_lst([-32, 0, 0, 10, 0, -3, 0, 0])

    assert integrate(to_fraction_lst([1])) == to_fraction_lst([1, 0])
    assert integrate(to_fraction_lst([2, 0])) == to_fraction_lst([1, 0, 0])
    assert integrate(to_fraction_lst([0])) == to_fraction_lst([0])
    assert integrate(to_fraction_lst([5, 4, 3, 2, 1])) == to_fraction_lst(
        [1, 1, 1, 1, 1, 0]
    )
    assert integrate(to_fraction_lst([9, 4, 5])) == to_fraction_lst([3, 2, 5, 0])
    assert integrate(to_fraction_lst([-9, 4, -5])) == to_fraction_lst([-3, 2, -5, 0])
